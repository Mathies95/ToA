...
if (interactive()) setwd(dirname(rstudioapi::getActiveDocumentContext()$path)) # set working dir to current file location. smort
knitr::opts_chunk$set(echo = TRUE, #output of EACH chunck. false is only the result
                      cache = TRUE, autodep = TRUE)#cashe complie a document fast. auto dept fill from start to buttom
options(width = 100)  # set output width to limit to 100
knitr::opts_chunk$set(echo = TRUE, 
                      fig.align = "center",# result in the center
                      message = FALSE)
#warrning = FALSE dont display messages
```
...
knitr::include_graphics("img/luke-skywalker.png")#add pictures in a chunk. warning = F removes the warning messages
```
